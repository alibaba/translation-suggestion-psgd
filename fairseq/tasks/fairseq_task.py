...
class FairseqTask(object):
    ...
    def inference_step(
        self, generator, models, sample, prefix_tokens=None, constraints=None, suffix_tokens=None, patience=0, **kwargs
    ):
        with torch.no_grad():
            return generator.generate(
                models, sample, prefix_tokens=prefix_tokens, constraints=constraints, suffix_tokens=suffix_tokens, patience=patience, **kwargs
            )
